...
App.templates = {
    ...
    nav: _("<%\nvar active = {};\nvar section = window.location.pathname.replace('-','').split('/')[1];\nvar app = (/data|styles|projects|uploads|account/).test(section);\n\nif (section === 'dataplatform') app = false;\nif (section) active[section] = 'active';\nif ((/mapbox\\.js|mapbox-ios-sdk|mbxmapkit|tilemill|carto/).test(section)) active.developers = 'active';\nif ((/foundations/).test(section)) active.help = 'active';\n%>\n  <div class='z10 strong small pad0y space primary hide-mobile'>\n\n  <% if (!app) { %>\n    <a href='/design/'        class='primary-nav-button inline pad1x pad0y round <%=active.design||''%>'>Design</a><!--\n --><a href='/data-platform/' class='primary-nav-button inline pad1x pad0y round <%=active.dataplatform||''%>'>Data</a><!--\n --><a href='/industries'     class='primary-nav-button inline pad1x pad0y round <%=active.industries||''%>'>Industries</a><!--\n --><a href='/enterprise/'    class='primary-nav-button inline pad1x pad0y round <%=active.enterprise||''%>'>Enterprise</a><!--\n --><a href='/plans/'         class='primary-nav-button inline pad1x pad0y round <%=active.plans||''%>'>Plans</a>\n  <% } %>\n\n    <a href='/help/'          class='primary-nav-button inline pad1x pad0y round quiet <%=active.help||''%>'>Help</a><!--\n --><a href='/developers/'    class='primary-nav-button inline pad1x pad0y round quiet <%=active.developers||''%>'>Developers</a><!--\n --><a href='/blog/'          class='primary-nav-button inline pad1x pad0y round quiet <%=active.blog||''%>'>Blog</a><!--\n\n  <% if (app) { %>\n --><div class='clearfix round inline align-top stroke primary-nav-wrap'><!--\n   --><a href='/projects/' class='primary-nav-button fill-lighten1 micro inline pad1x pad0y icon folder <%=active.projects||''%>'>Projects</a><!--\n   --><a href='/styles/'   class='primary-nav-button fill-lighten1 micro inline pad1x pad0y icon paint <%=active.styles||''%>'>Styles</a><!--\n   --><a href='/data/'     class='primary-nav-button fill-lighten1 micro inline pad1x pad0y icon cloud <%=active.data||''%>'>Data</a><!--\n   --><a href='/account/'  class='primary-nav-button fill-lighten1 micro inline pad1x pad0y <%=active.account||''%>'>\n        <img class='inline dot align-top avatar' src='<%= user.avatar %>' /><span><%= _(user.id || user.name).escape() %></span>\n      </a><!--\n--></div><!--\n  <% } %>\n\n  <% if (!user.id) { %>\n    --><a href='#signin' class='primary-nav-button inline pad1x pad0y round signin auth-signin'>Sign in</a><!--\n    --><div class='clearfix round inline align-top stroke primary-nav-wrap clip'><a href='/signup/' class='primary-nav-button fill-lighten1 inline pad1x pad0y'>Sign up</a></div><!--\n  <% } else if (!app) { %>\n --><div class='clearfix round inline align-top stroke primary-nav-wrap'><!--\n   --><a href='/projects/'tooltip='Projects' class='primary-nav-button contain fill-lighten1 masthead-tooltip micro inline pad0 icon folder'></a><!--\n   --><a href='/styles/'  tooltip='Styles'   class='primary-nav-button contain fill-lighten1 masthead-tooltip micro inline pad0 icon paint'></a><!--\n   --><a href='/data/'    tooltip='Data'     class='primary-nav-button contain fill-lighten1 masthead-tooltip micro inline pad0 icon cloud'></a><!--\n   --><a href='/account/' tooltip='Account'  class='primary-nav-button contain fill-lighten1 masthead-tooltip micro inline pad0'><img class='inline dot align-top avatar' src='<%= user.avatar %>' /></a><!--\n--></div><!--\n  <% } %>\n\n  <% if (user.id) { %>\n    --><a href='#signout' tooltip='Signout' class='contain micro primary-nav-button inline pad0 round icon logout masthead-tooltip js-signout'></a><!--\n  <% } %>\n\n--></div>\n\n  <div class='show-mobile contain dropdown-container pin-topright'>\n    <a href='#menu' class='dark contain z1 big inline icon menu round quiet dropdown-button js-dropdown-button pin-right'></a>\n    <div id='menu' class='js-dropdown-menu scroll-v dropdown-menu offcanvas-top fill-blue clip col12 pin-top animate'>\n      <div class='mobile-cols pad4y keyline-bottom clearfix'>\n        <% if (!user.id) { %>\n          <a class='pad1 block strong col6' href='/design/'>Design</a>\n          <a class='pad1 block strong col6' href='/data-platform/'>Data</a>\n          <a class='pad1 block strong col6' href='/developers/'>Develop</a>\n          <a class='pad1 block strong col6' href='/showcase/'>Showcase</a>\n          <a class='pad1 block strong col6 signin' href='#signin'>Sign in</a>\n          <a class='pad1 block strong col6' href='/signup/'>Sign up</a>\n        <% } else { %>\n          <a class='pad1 block strong col6 icon folder' href='/projects/'>Projects</a>\n          <a class='pad1 block strong col6' href='/developers/'>Developers</a>\n          <a class='pad1 block strong col6 icon paint' href='/styles/'>Styles</a>\n          <a class='pad1 block strong col6' href='/account/'>\n            <img class='inline dot avatar' src='<%= user.avatar %>' />\n            <span><%= _(user.id || user.name).escape() %></span>\n          </a>\n          <a class='pad1 block strong col6 icon cloud' href='/data/'>Data</a>\n          <a href='#signout' class='pad1 block strong col6 icon logout js-signout'>Signout</a>\n        <% } %>\n      </div>\n      <div class='clearfix mobile-cols pad4y'>\n        <a class='pad1 block col6 strong quiet' href='/blog/'>Blog</a>\n        <a class='pad1 block col6 strong quiet' href='/enterprise/'>Enterprise</a>\n        <a class='pad1 block col6 strong quiet' href='/industries/'>Industries</a>\n        <a class='pad1 block col6 strong quiet' href='/plans/'>Plans</a>\n        <a class='pad1 block col6 strong quiet' href='/help/'>Help</a>\n        <a class='pad1 block col6 strong quiet' href='/about/'>About</a>\n        <a class='pad1 block col6 strong quiet' href='/about/team/'>Team</a>\n        <a class='pad1 block col6 strong quiet' href='/jobs/'>Jobs</a>\n        <a class='pad1 block col6 strong quiet' href='/about/press/'>Press</a>\n        <a class='pad1 block col6 strong quiet' href='/about/press-kit/'>Press kit</a>\n        <a class='pad1 block col6 strong quiet' href='/tos/'>Legal</a>\n        <a class='pad1 block col6 strong quiet' href='/contact/'>Contact</a>\n        <a class='pad1 block col6 strong quiet' href='/education/'>Education</a>\n        <a class='pad1 block col6 strong quiet' href='/security/'>Security</a>\n      </div>\n    </div>\n  </div>\n").template(),
